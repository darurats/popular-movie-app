...
import com.darurats.android.popularmovies.utils.PollingCheck;
...
import static com.darurats.android.popularmovies.data.MovieContract.MovieEntry.COLUMN_TITLE;
import static com.darurats.android.popularmovies.data.MovieContract.MovieEntry.COLUMN_POSTER_PATH;
import static com.darurats.android.popularmovies.data.MovieContract.MovieEntry.COLUMN_OVERVIEW;
import static com.darurats.android.popularmovies.data.MovieContract.MovieEntry.COLUMN_BACKDROP_PATH;
import static com.darurats.android.popularmovies.data.MovieContract.MovieEntry.COLUMN_RELEASE_DATE;
import static com.darurats.android.popularmovies.data.MovieContract.MovieEntry.COLUMN_RATING;
import static com.darurats.android.popularmovies.data.MovieContract.MovieEntry.COLUMN_MOVIE_ID;
 ...
 * Provider.
 * <p>
 * NOTE: If your MovieContract class doesn't exactly match ours, THIS WILL NOT WORK as we've
...
class TestUtilities {
    ...
    static ContentValues createTestMovieContentValues() {
        ...
        testMovieValues.put(COLUMN_TITLE, "The Legend of Suparman");
        testMovieValues.put(COLUMN_POSTER_PATH, "/w185/poster.jpg");
        testMovieValues.put(COLUMN_OVERVIEW, "Batman vs Superman Overview");
        testMovieValues.put(COLUMN_RELEASE_DATE, "1988/11/11");
        testMovieValues.put(COLUMN_RATING, 99.5);
        testMovieValues.put(COLUMN_BACKDROP_PATH, "/original/backdrop.jpg");
        testMovieValues.put(COLUMN_MOVIE_ID, 11);
